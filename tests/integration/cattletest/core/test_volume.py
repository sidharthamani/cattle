...
def test_create_container_with_volume(new_context, super_client):
    ...
    host1 = super_client.list_storagePoolHostMap(storagePoolId=vsp1[0].storagePoolId)
    host2 = super_client.list_storagePoolHostMap(storagePoolId=vsp2[0].storagePoolId)
